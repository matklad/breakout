...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj9446 = {};return obj9446;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7917__auto__ = this$;if(and__7917__auto__)
...
{var x__8556__auto__ = (((this$ == null))?null:this$);return (function (){var or__7929__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__8556__auto__)]);if(or__7929__auto__)
{return or__7929__auto__;
} else
{var or__7929__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7929__auto____$1)
...
return (function (p__9447){var vec__9448 = p__9447;var k = cljs.core.nth.call(null,vec__9448,0,null);var v = cljs.core.nth.call(null,vec__9448,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__9449){var vec__9450 = p__9449;var k = cljs.core.nth.call(null,vec__9450,0,null);var v = cljs.core.nth.call(null,vec__9450,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
