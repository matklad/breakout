...
{{
var G__13528 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13528;
continue;
}
} else
...
{var pred__13532 = cljs.core._EQ_;var expr__13533 = limit;if(cljs.core.truth_(pred__13532.call(null,1,expr__13533)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13532.call(null,2,expr__13533)))
...
var G__13535 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13536 = (limit__$1 - 1);
var G__13537 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13535;
limit__$1 = G__13536;
parts = G__13537;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___13539 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___13539))
{var replacement_13540 = temp__4124__auto___13539;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_13540)));
} else
{buffer.append(ch);
}
{
var G__13541 = (index + 1);
index = G__13541;
continue;
}
}
