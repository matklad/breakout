...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16268 = 0;while(true){
var m_16269 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16269 == null))
{} else
{m_16269.call(null);
if((count_16268 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16270 = (count_16268 + 1);
count_16268 = G__16270;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7917__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7917__auto__)
