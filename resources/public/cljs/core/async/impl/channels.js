...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t16274 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t16274 = (function (val,box,meta16275){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t16274.cljs$lang$type = true;
cljs.core.async.impl.channels.t16274.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t16274";
cljs.core.async.impl.channels.t16274.cljs$lang$ctorPrWriter = (function (this__8496__auto__,writer__8497__auto__,opt__8498__auto__){return cljs.core._write.call(null,writer__8497__auto__,"cljs.core.async.impl.channels/t16274");
});
cljs.core.async.impl.channels.t16274.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t16274.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16276){var self__ = this;
var _16276__$1 = this;return self__.meta16275;
});
cljs.core.async.impl.channels.t16274.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16276,meta16275__$1){var self__ = this;
var _16276__$1 = this;return (new cljs.core.async.impl.channels.t16274(self__.val,self__.box,meta16275__$1));
});
cljs.core.async.impl.channels.__GT_t16274 = (function __GT_t16274(val__$1,box__$1,meta16275){return (new cljs.core.async.impl.channels.t16274(val__$1,box__$1,meta16275));
});
}
return (new cljs.core.async.impl.channels.t16274(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8499__auto__,writer__8500__auto__,opts__8501__auto__){return cljs.core._write.call(null,writer__8500__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8496__auto__,writer__8497__auto__,opt__8498__auto__){return cljs.core._write.call(null,writer__8497__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_16277 = self__.takes.pop();if((taker_16277 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_16277))
{var take_cb_16278 = cljs.core.async.impl.protocols.commit.call(null,taker_16277);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_16278,taker_16277,this$__$1){
return (function (){return take_cb_16278.call(null,null);
});})(take_cb_16278,taker_16277,this$__$1))
);
} else
{}
{
